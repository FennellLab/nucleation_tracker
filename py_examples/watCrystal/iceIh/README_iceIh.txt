# This is an example folder containing the crystal structures of ice Ih generated using Genice2/2.1.5 program (https://github.com/vitroid/GenIce). 
...
-> For iceIh
$ nucleation_tracker.py -f iceIh.gro -r 10 -m hbondAngle
Output Files: iceIh_CA_ringsCount.dat
...
-> For iceIh
$ nucleation_tracker.py -f iceIh.gro -r 10 -m hbondAngle -d
Output Files: iceIh_DCA_ringsCount.dat
 

3. These options help to count the number of unprunned rings formed by at most 10 H-bonds. 
-> For iceIh
$ nucleation_tracker.py -f iceIh.gro -r 10 -c 1
Output Files: iceIh_unprunned_ringsCount.dat

4. These options help to count the number of unprunned directional rings formed by at most 10 H-bonds.
-> For iceIh
$ nucleation_tracker.py -f iceIh.gro -r 10 -c 1 -d
Output Files: iceIh_D_unprunned_ringsCount.dat
