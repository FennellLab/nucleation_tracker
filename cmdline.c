  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'c':	/* Close rings using either (0) the single minimum path for each water molecule or (1) all ring paths..  */
